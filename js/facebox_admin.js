...
(function($) {
  ...
  $.extend($.facebox, {
    settings: {
      ...
      opacity      : 0,
      overlay      : true,
      loadingImage : url+'/wp-content/plugins/apptha-slider-gallery/images/facebox/loading.gif',
      closeImage   : url+'/wp-content/plugins/apptha-slider-gallery/images/facebox/close.gif',
